...
import TiendaSteve.domain.Item;
import TiendaSteve.domain.Factura;
import TiendaSteve.domain.Usuario;
import TiendaSteve.services.CarritoService;
import TiendaSteve.services.FacturaService;
import TiendaSteve.services.UsuarioService;
...
public class CarritoController {
    ...
    public String verFactura(@ModelAttribute("idFactura") Long idFactura, Model model) {
        if (idFactura == null) {
